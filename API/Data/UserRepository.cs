...
namespace API.Data
{
    public class UserRepository : IUserRepository
    {
        ...
        {
            return await _context.Users.Include(p => p.Photos).Include(i => i.PreferredInstruments).SingleOrDefaultAsync(x => x.UserName == username);
        }

        public async Task<IEnumerable<AppUser>> GetUsersAsync()
        {
            return await _context.Users.Include(p => p.Photos).Include(i => i.PreferredInstruments).ToListAsync();
        }
